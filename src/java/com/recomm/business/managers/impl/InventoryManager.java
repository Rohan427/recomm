...
////        prices = priceSvc.readPrices();
	...
	private synchronized Collection<IBrand> readAllBrands()
	{
        Collection<IBrand> brands = null;
     ...
     */
    @Override
	public synchronized boolean update (IBrand brand, String command)
	{
		boolean result = false;
     ...
     */
    @Override
    public synchronized IBrand read (IBrand brand)
	{
